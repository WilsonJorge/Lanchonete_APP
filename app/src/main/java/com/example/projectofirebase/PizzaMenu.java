                ...
                switch (view.getId())
                {
                    case R.id.fab_pizza_1:
                        if (flag==true)
                        {
                            ...
                            tvInforPizza1.setText("Esta pizza Margarita foi selecionado por ser um alimento rico em calcio e em licopeno");
                            flag=false;
                        }
                        else {
                            flag=true;
            ...
            public void onClick(View view) {
                switch (view.getId())
                {
                    ...
                    if (flag==true)
                    {
                        ...
                        tvInforHamburguer1.setText("Esta Pizza Mexicana foi selecionado por ser um pizza feita a atum e e umas das pizzas menos caloricas e saudavel");
                        flag=false;
                    }
                    else {
                        flag=true;
